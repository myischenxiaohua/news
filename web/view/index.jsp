...
<c:choose>
  <c:when test="${requestScope.tnews == null && requestScope.hnews == null && requestScope.news == null}">
    <jsp:forward page="/index.html?action=index"></jsp:forward>
  </c:when>
  <c:otherwise>
    ...
    <div id="header">
      <div id="top_login">
        <form action="util/user" method="post" onsubmit="return check()">
          ...
          <img src="${pageContext.request.contextPath}/static/images/friend_logo.gif" alt="Google" id="friend_logo" />
        </form>
      </div>
      <div id="nav">
        <div id="logo"> <img src="${pageContext.request.contextPath}/static/images/logo.jpg" alt="新闻中国" /> </div>
        <div id="a_b01"> <img src="${pageContext.request.contextPath}/static/images/a_b01.gif" alt="" /> </div>
        <!--mainnav end-->
      </div>
    </div>
    <div id="container">

      <%@ include file="/view/layout/index_sideBar.jsp"%>

      <div class="main">
        <div class="class_type"> <img src="${pageContext.request.contextPath}/static/images/class_type.gif" alt="新闻中心" /> </div>
        <div class="content">
          <ul class="class_date">
            <c:forEach items="${requestScope.topics}" var="topic" varStatus="i">
